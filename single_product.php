...
?>
    ...
    <div class="page-contain single-product">
        <div class="container">
         ...
         $thePost = $_GET['single'];
         $sql = "SELECT * FROM product_info_ctg WHERE pro_id ='$thePost'";
               ...
               <form action="addtocart.php" method="POST">
                    ...
                    <div class="media">
                        <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                            <li><img src="admin/upload/<?php echo $pro_image; ?>" alt="" width="500" height="500"></li>
                    ...
                    <div class="product-attribute">
                        ...
                        <div class="rating">
                            ...
                            <b class="category"><?php echo $cat_name; ?></b>
                        </div>
                        <span class="sku">Sku: #<?php echo $pro_id; ?></span>
                        <p class="excerpt"><?php echo $pro_desc; ?></p>
                        <div class="price">
                            <ins><span class="price-amount"><span class="currencySymbol">Price: £</span><?php echo $pro_price; ?></span></ins>
                    ...
                    <div class="action-form">
                        ...
                        <div class="buttons">
                            ...
                            <input type="submit" value="ADD TO CART"  name="addtocart" class="btn btn-block add-to-cart-btn">
                            <p class="pull-row">
                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="product-title"><a href="single_product.php?single=<?php echo $pro_id; ?>" class="pr-name"><?php echo $pro_name; ?></a></h4>
                                    <div class="price">
